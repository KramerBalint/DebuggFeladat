namespace DebuggFeladat
{
    ...
    class Program
    {
        ...
        // Raktár
        static string[] raktarTermekek = new string[10] {"Alma", "Körte", "Barack", "Banán", "Saláta", "Paradicsom", "Sajt", "Csoki", "McNuggets", "Krumpli" };
        static int[] raktarMennyisegek = new int[10] {523, 523, 131, 542, 123, 523, 2423, 13, 542, 3124532};
